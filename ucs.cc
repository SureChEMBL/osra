...
int UCS::base_letter( int code ) throw()
  {
  switch( code )
    {
    case CAGRAVE:
...
int UCS::compose( int letter, int accent ) throw()
  {
  switch( letter )
    {
...
bool UCS::isalnum( int code ) throw()
  {
  return ( UCS::isalpha( code ) || UCS::isdigit( code ) );
  }


bool UCS::isalpha( int code ) throw()
  {
  return ( ( code < 128 && std::isalpha( code ) ) || base_letter( code ) );
  }


bool UCS::isdigit( int code ) throw()
  {
  return ( code <= '9' && code >= '0' );
  }


bool UCS::islower( int code ) throw()
  {
  if( code < 128 && std::islower( code ) ) return true;
  code = base_letter( code );
  return ( code && std::islower( code ) );
  }


bool UCS::islower_small( int code ) throw()
  {
...
bool UCS::islower_small_ambiguous( int code ) throw()
  {
  if( code >= 128 || !std::islower( code ) ) return false;
  switch( code )
    {
...
bool UCS::isspace( int code ) throw()
  {
  return ( code < 128 && std::isspace( code ) );
  }


bool UCS::isupper( int code ) throw()
  {
  if( code < 128 && std::isupper( code ) ) return true;
  code = base_letter( code );
  return ( code && std::isupper( code ) );
  }


bool UCS::isvowel( int code ) throw()
  {
...
char UCS::map_to_byte( int code ) throw()
  {
  if( code < 0 ) return 0;
...
char * UCS::ucs_to_utf8( int code ) throw()
  {
  static char s[7];
...
int UCS::to_nearest_digit( int code ) throw()
  {
  switch( code )
    {
    case 'O':
...
int UCS::to_nearest_letter( int code ) throw()
  {
  switch( code )
    {
    case '0': return 'O';
...
int UCS::toupper( int code ) throw()
  {
