...
void arrange_plus_sings_between_boxes(const vector < vector<int> > &before,const vector<box_t> &page_of_boxes,const vector<point_t> &pluses, vector < vector <bool> > &is_plus)
{
  for (int i=0; i<before.size(); i++)
