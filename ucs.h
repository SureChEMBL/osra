...
int base_letter( int code ) throw();
int compose( int letter, int accent ) throw();
bool isalnum( int code ) throw();
bool isalpha( int code ) throw();
bool isdigit( int code ) throw();
bool islower( int code ) throw();
bool islower_small( int code ) throw();
bool islower_small_ambiguous( int code ) throw();
bool isspace( int code ) throw();
bool isupper( int code ) throw();
bool isvowel( int code ) throw();
char map_to_byte( int code ) throw();
char * ucs_to_utf8( int code ) throw();
int to_nearest_digit( int code ) throw();
int to_nearest_letter( int code ) throw();
int toupper( int code ) throw();
